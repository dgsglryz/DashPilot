    ...
    <div class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-gray-400 mt-1">Manage your team and access permissions</p>
        </div>
        <button 
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700/50 p-5">
          ...
          <p class="text-2xl font-bold text-white mt-1">{{ stats.admins }}</p>
        </div>
        <div class="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700/50 p-5">
      ...
      <div class="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700/50 overflow-hidden">
        <table class="w-full">
          ...
          <tbody class="divide-y divide-gray-700/50">
            <tr v-for="member in members" :key="member.id" class="hover:bg-gray-700/20 transition-colors">
              <td class="px-6 py-4">
              ...
              <td class="px-6 py-4">
                ...
                >
                  <span class="w-1.5 h-1.5 rounded-full" :class="getStatusDotClass(member.status)"></span>
                  {{ member.status }}
                </span>
              </td>
              <td class="px-6 py-4">
                <span class="text-gray-400 text-sm">{{ formatRelativeTime(member.lastActiveAt) }}</span>
              </td>
              <td class="px-6 py-4">
