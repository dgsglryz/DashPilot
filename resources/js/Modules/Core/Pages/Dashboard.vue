...
<template>
    ...
    <div class="min-h-screen bg-[#111111] text-gray-100">
        <div class="flex">
            <aside
                class="hidden min-h-screen w-64 flex-col bg-[#d1d1d1] p-6 text-gray-900 md:flex"
            >
                <div
                    class="flex items-center gap-3 rounded-2xl bg-[#bebebe] p-4"
                >
                    <img
                ...
                <div class="flex flex-col gap-6 lg:flex-row">
                    <section class="flex-1">
                        ...
                        >
                            ...
                            >
                                <div
                                    class="flex flex-1 items-center rounded-full bg-[#2c2c2c] px-4 py-2 text-sm text-gray-300 sm:flex-none sm:w-72"
                                >
                                    <input
                                        type="text"
                                        placeholder="Search"
                                ...
                                <button class="rounded-full bg-[#2c2c2c] p-3">
                            ...
                            >
                                <div class="flex gap-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <dl
                                            class="mt-4 flex flex-wrap gap-4 text-sm text-gray-200"
                                        >
                                            <div
                        ...
                        <section
                            class="mt-8 rounded-3xl bg-[#0f0f0f] p-6 text-gray-100 shadow-2xl"
                        >
                            ...
                            <div
                                class="mt-6 grid gap-3 rounded-3xl bg-[#1e1e1e] p-4 text-gray-900 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-7"
                            >
                                <div
                        ...
                        <section
                            class="mt-8 rounded-3xl bg-[#1f1f1f] p-6 shadow-2xl"
                        >
                            <div class="flex items-center justify-between">
                                <h2 class="text-xl font-semibold">
                                    Recent Activity
                    ...
                    <aside
                        class="w-full max-w-sm rounded-3xl bg-[#e0e0e0] p-6 text-gray-900 shadow-2xl"
                    >
                        <div class="rounded-3xl bg-white p-4 shadow">
                            ...
                            <div class="mt-4 rounded-2xl bg-gray-100 p-4">
                                ...
                                <p class="text-sm font-semibold">
                                    Active sites:
                                    {{ operations.sitePerformance.activeSites }}
                                </p>
                                <p class="text-sm text-gray-600">
                                    Status:
                                    {{ operations.sitePerformance.status }}
                                </p>
                            </div>
                        </div>

                        <div
                            class="mt-6 space-y-4 rounded-3xl bg-white p-4 shadow"
                        >
