...
/**
 * Site Edit Page - Form to edit an existing site.
 */
...
type Site = {
    ...
    name: string;
    url: string;
    type: 'wordpress' | 'shopify' | 'woocommerce' | 'custom';
...
/**
 * Submit the form to update the site
 */
const submit = (): void => {
    ...
    <AppLayout>
        <div class="space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-white">Edit Site</h1>
