      ...
      <div class="bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
        <div class="flex flex-col lg:flex-row gap-4">
          ...
          <div class="flex gap-2">
            <select v-model="filterPlatform" class="px-4 py-2 bg-gray-900 border border-gray-700 rounded-lg text-white focus:outline-none focus:border-blue-500">
        ...
        <div class="bg-gradient-to-br from-green-500/10 to-green-600/5 border border-green-500/20 rounded-xl p-4">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-2xl font-bold text-white mt-1">{{ stats.healthy }}</p>
            </div>
          ...
          <table class="w-full">
            <thead class="bg-gray-900/50">
              <tr>
                ...
                <th class="px-6 py-4 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Uptime</th>
                <th class="px-6 py-4 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Response Time</th>
                <th class="px-6 py-4 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Last Checked</th>
            ...
            <tbody class="divide-y divide-gray-700/50">
              <tr v-for="site in filteredSites" :key="site.id" class="hover:bg-gray-700/20 transition-colors" :class="{ 'bg-blue-500/10': selectedSites.includes(site.id) }">
                ...
                <td class="px-6 py-4">
                  <span class="text-white font-medium">{{ site.uptime }}%</span>
                </td>
                <td class="px-6 py-4">
                  <span class="text-white">{{ site.responseTime }}ms</span>
                </td>
                <td class="px-6 py-4">
...
const filteredSites = computed(() => {
  return props.sites.filter(site => {
    ...
    const matchesPlatform = filterPlatform.value === 'all' || site.platform === filterPlatform.value
    const matchesStatus = filterStatus.value === 'all' || site.status === filterStatus.value
